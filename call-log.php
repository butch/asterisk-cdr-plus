...
$FG_TABLE_COL[]=array ("Дата", "calldate", "13%", "center", "SORT", "19");
...
$FG_TABLE_COL[]=array ("DstChannel", "dstchannel", "10%", "center", "", "50","dstchannel");
...
$FG_TABLE_COL[]=array ("Audio", "uuid", "20%", "center", "", "80", "shit");
...
$FG_COL_QUERY='calldate, src, dst, dst, dstchannel, disposition, duration, uuid';
		...
		<table class="bar-status" width="75%" border="0" cellspacing="1" cellpadding="2" align="center">
			<tbody><tr>
        		<td class="bar-search" align="left" bgcolor="#555577">
					...
					<font face="verdana" size="1" color="#ffffff"><b>Выберите месяц</b></font>
				</td>
        		...
        		<td align="left" bgcolor="#000033">
      			...
      			<td align="left" bgcolor="#acbdee">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#acbdee"><tr><td>
	  				<input type="checkbox" name="fromday" value="true" <? if ($fromday){ ?>checked<?}?>> С : 
					...
					<input type="checkbox" name="today" value="true" <? if ($today){ ?>checked<?}?>> До : 
			...
			<tr>
				<td class="bar-search" align="left" bgcolor="#555577">				
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;Продолжительность</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#cddeff">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
				<td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="duration1" size="4" value="<?=$duration1?>"></td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration1type" value="4" <?if($duration1type==4){?>checked<?}?>>&gt;</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration1type" value="5" <?if($duration1type==5){?>checked<?}?>>&gt; egal</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration1type" value="1" <?if((!isset($duration1type))||($duration1type==1)){?>checked<?}?>>Egal</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration1type" value="2" <?if($duration1type==2){?>checked<?}?>>&lt; egal</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration1type" value="3" <?if($duration1type==3){?>checked<?}?>>&lt;</td>	
				<td width="5%" class="bar-search" align="center" bgcolor="#cddeff"></td>
				
				<td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="duration2" size="4" value="<?=$duration2?>"></td>			
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration2type" value="4" <?if($duration2type==4){?>checked<?}?>>&gt;</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration2type" value="5" <?if($duration2type==5){?>checked<?}?>>&gt; egal</td>								
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration2type" value="2" <?if($duration2type==1){?>checked<?}?>>&lt; egal</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="duration2type" value="3" <?if($duration2type==3){?>checked<?}?>>&lt;</td>	
				</tr></table>
				</td>
			</tr>	
...
<TBODY>
				...
				?>
						...
						<?	//$FG_TABLE_COL[$i][1];			
							...
							}elseif ($FG_TABLE_COL[$i][6]=="dstchannel"){
									$record_display = dstchannel($recordset[$i]);
							}else{
